...
public class WxMpMaterialFileBatchGetResult implements Serializable {
	private static final long serialVersionUID = 3908155720249566494L;
	...
	public String toString() {
		return "WxMpMaterialFileBatchGetResult [" + "totalCount=" + totalCount + ", itemCount=" + itemCount + ", items="
				+ items + "]";
	}
	...
	public static class WxMaterialFileBatchGetNewsItem {
		...
		@Override
		public String toString() {
			return "WxMaterialFileBatchGetNewsItem [" + "mediaId=" + mediaId + ", updateTime=" + updateTime + ", name="
					+ name + ", url=" + url + "]";
		}
	}
}
