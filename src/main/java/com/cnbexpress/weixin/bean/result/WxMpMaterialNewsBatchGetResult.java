...
import com.cnbexpress.weixin.bean.WxMpMaterialNews;
...
public class WxMpMaterialNewsBatchGetResult implements Serializable {
	private static final long serialVersionUID = 2074706279225456798L;
	...
	public String toString() {
		return "WxMpMaterialNewsBatchGetResult [" + "totalCount=" + totalCount + ", itemCount=" + itemCount + ", items="
				+ items + "]";
	}
