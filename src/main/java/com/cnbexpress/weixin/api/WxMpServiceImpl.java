...
import com.cnbexpress.weixin.common.util.RandomUtils;
import com.cnbexpress.weixin.common.util.StringUtils;
import com.cnbexpress.weixin.common.util.crypto.SHA1;
import com.cnbexpress.weixin.common.util.crypto.WxCryptUtil;
import com.cnbexpress.weixin.common.util.fs.FileUtils;
import com.cnbexpress.weixin.common.util.http.*;
import com.cnbexpress.weixin.common.util.json.GsonHelper;
import com.cnbexpress.weixin.common.util.json.WxGsonBuilder;
import com.cnbexpress.weixin.common.util.xml.XStreamInitializer;
import com.cnbexpress.weixin.util.http.*;
...
public class WxMpServiceImpl implements WxMpService {
	...
	private int retryAccessTokenSleepMillis = 2000;

	private int maxRetryAccessTokenTimes = 3;
	...
	public InputStream materialImageOrVoiceDownload(String media_id) throws WxErrorException {
		...
		return execute(new MaterialVoiceAndImageDownloadRequestExecutor(), url, media_id);
	}
